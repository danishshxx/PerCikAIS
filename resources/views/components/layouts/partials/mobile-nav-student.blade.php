{{-- ========================================
    MOBILE LAYOUT — STUDENT (PerCikAIS)
    ...
    <header class="fixed top-0 left-0 right-0 h-16 bg-white/80 dark:bg-[#0b0f19]/80 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 z-50 flex items-center justify-between px-5 transition-colors duration-300">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
            ...
            <div>
                ...
                <span class="block text-[9px] font-semibold text-slate-400 -mt-0.5">Student Space</span>
            </div>
        </a>
            ...
            <div class="relative" x-on:click.outside="mobileProfileOpen = false">
                ...
                >
                    <div class="px-3 py-2.5">
                        ...
                        <p class="text-[10px] text-slate-400 truncate mt-1 leading-none">Siswa</p>
                    </div>
                    <div class="h-px bg-slate-100 dark:bg-slate-800 my-1"></div>
                    <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-[12px] text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition">
                        <svg class="h-3.5 w-3.5 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 20a8 8 0 0 1 16 0" /></svg>
                        Profil Saya
                    </a>
                    <a href="{{ route('settings.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-[12px] text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition">
